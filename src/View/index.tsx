// ============================================================================
// VIEW: Tela Inicial (Categorias)
// Responsável apenas por renderizar o estado exposto pela useHomeViewModel.
// Não conhece o DataSource, nem chama hooks de navegação diretamente.
// ============================================================================
          ...
          <View style={styles.gridCategorias}>
            {state.categorias.map((cat) => (
              <TouchableOpacity
                ...
                onPress={() => actions.handleSelecionarCategoria(cat.id)}
              >
